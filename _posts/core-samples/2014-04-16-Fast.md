...
O que fizemos foi simplesmente criar uma Classe que implementa o IToolRepository, e na implementação de seu método retornamos uma , que é o que o nosso método que estamos testando espera do banco de dados.
