...
O que fizemos foi simplesmente criar uma Classe que implementa o IToolRepository, e na de seu método retornamos uma "List<Tool>", que é o que o nosso método que estamos testando espera do banco de dados.
